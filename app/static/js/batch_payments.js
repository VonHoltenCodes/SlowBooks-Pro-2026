...
const BatchPaymentsPage = {
    async render() {
        ...
        if (Object.keys(byCustomer).length === 0) {
            ...
            html += '<div class="table-container"><table><thead><tr><th scope="col"></th><th scope="col">' + T('Invoice') + '</th><th scope="col">' + T('Customer') + '</th><th scope="col">Due</th><th scope="col" class="amount">Balance</th><th scope="col" class="amount">Payment</th></tr></thead><tbody>';
